...
var sanpham = [
	{
		...
		'<div class="col-xs-12 col-sm-4">'+
			'<div class="thumbnail">'+
				...
				'<div class="hovereffect"><a href="aokhoac1.html"><img style="width:100%" src="img/aokhoac1.jpg" alt=""><div class="overlay"><h2>' +
			    'Áo Giáp Bảo Hộ Đi DG Motor</h2></div></a></div>'+
...
function showsp(i) {
	return sanpham[i].content;
}

function showkm() {
	var allkm = '';
	for(var i=0;i<sanpham.length;i++){
		if(sanpham[i].khuyenmai){
			allkm= allkm+sanpham[i].content;
		}
	};
	if(allkm !== ''){
...
function showquan() {
	...
	for(var i=0;i<sanpham.length;i++){
		if(sanpham[i].quan){
			allquan= allquan+sanpham[i].content;
		}
	};
	if(allquan !== ''){
